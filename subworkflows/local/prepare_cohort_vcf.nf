...
include { SNPEFF_DOWNLOAD as SNPEFF_DOWNLOAD__NFCORE } from "../../modules/nf-core/snpeff/download.nf"
...
workflow PREPARE_COHORT_VCF {
    ...
    main:
        ...
        SNPEFF_DOWNLOAD__NFCORE([[ id:"Mycobacterium_bovis_bcg" ], "Mycobacterium_bovis_bcg" ])
        //SNPEFF__NFCORE(GATK_GENOTYPE_GVCFS.out, "Mycobacterium_bovis_bcg")
        BGZIP(SNPEFF.out)
