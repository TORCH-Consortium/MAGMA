 ...
 */
include { GATK_SELECT_VARIANTS as  GATK_SELECT_VARIANTS__SNP } from "../../modules/local/gatk/select_variants.nf" addParams ( params.GATK_SELECT_VARIANTS__SNP )
include { GATK_VARIANT_RECALIBRATOR as GATK_VARIANT_RECALIBRATOR__SNP } from "../../modules/local/gatk/variant_recalibrator.nf" addParams ( params.GATK_VARIANT_RECALIBRATOR__SNP )
include { GATK_APPLY_VQSR as GATK_APPLY_VQSR__SNP } from "../../modules/local/gatk/apply_vqsr.nf" addParams ( params.GATK_APPLY_VQSR__SNP )
include { GATK_SELECT_VARIANTS__EXCLUSION as  GATK_SELECT_VARIANTS__EXCLUSION__SNP } from "../../modules/local/gatk/select_variants__exclusion.nf" addParams ( params.GATK_SELECT_VARIANTS__EXCLUSION__SNP )
