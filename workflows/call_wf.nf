...
workflow CALL_WF {
    ...
    emit:
        ...
        /* reformatted_lofreq_vcfs_ch = GATK_INDEX_FEATURE_FILE__LOFREQ.out.collect() */
        reformatted_lofreq_vcfs_tuple_ch = GATK_INDEX_FEATURE_FILE__LOFREQ.out.vcf_tuple.collect()
