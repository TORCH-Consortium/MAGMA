...
workflow INDEL_ANALYSIS {
    ...
    arg_files_ch = Channel.of(["walker2015,known=true,training=true,truth=true,prior=15.0", file(params.walker2015_vcf), file(params.walker2015_vcf_tbi)],
        ...
        GATK_VARIANT_RECALIBRATOR__INDEL('INDEL', GATK_SELECT_VARIANTS__SNP.out, args_ch, resources_files_ch, resources_file_indexes_ch, params.ref_fasta, [params.ref_fasta_fai, params.ref_fasta_dict] )
